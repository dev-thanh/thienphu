...
class CategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['data'] = $this->categories->getCategories('product_category','ASC');

        return view("backend.{$this->module()['module']}.products.list", $data);
    }
    ...
    public function create()
    {
        ...
        $data['categories'] = $this->categories->getCategories('product_category','ASC');

        return view("backend.{$this->module()['module']}.products.create-edit", $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route("{$this->module()['module']}.index")->with('success', 'Thêm mới danh mục thành công');
    }
    ...
    public function edit($id)
    {
        ...
        $data['categories'] = $this->categories->getCateNotId($id, 'product_category');
    ...
    public function update(Request $request, $id)
    {
        ...
        $post_check_slug = $this->categories->getOrtherCateByType($id, $request->slug, 'product_category');
