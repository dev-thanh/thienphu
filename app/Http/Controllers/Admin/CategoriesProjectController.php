...
class CategoriesProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['data'] = $this->categories->getCategories('project_category','ASC');

        return view("backend.category.projects.list", $data);
    }
    ...
    public function create()
    {
        ...
        $data['categories'] = $this->categories->getCategories('project_category','ASC');

        return view("backend.category.projects.create-edit", $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route("category-project.index")->with('success', 'Thêm mới danh mục thành công');
    }
    ...
    public function edit($id)
    {
        ...
        $data['categories'] = $this->categories->getCateNotId($id, 'project_category');
    ...
    public function update(Request $request, $id)
    {
        ...
        $post_check_slug = $this->categories->getOrtherCateByType($id, $request->slug, 'project_category');
    ...
    public function destroy($id)
    {
        ...
        if(count($category)){
            ...
            return redirect()->route('category-project.index')->with('success', 'Xóa danh mục thành công');
